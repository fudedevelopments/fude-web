              ...
              >
                ...
                >
                  ...
                  <motion.p
                    ...
                    transition={{ duration: 0.6, delay: 0.4 }}
                  >
                    Have a project in mind? We&apos;d love to hear from you. Get
                    in touch and let&apos;s discuss how we can bring your vision
                    to life with our AI-powered solutions.
                  </motion.p>
                  ...
                  <div className='space-y-6'>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className='text-white'>Slatter Nagar, Perunduari</p>
                        <p className='text-white'>Erode - 638053, Tamil Nadu</p>
                      </div>
                    </motion.div>
      ...
      <section className='py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/50'>
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='space-y-6'>
            {[
              {
                question: 'What services does Fude Development offer?',
                answer:
                  'We specialize in AI development, web solutions, mobile applications, and automation systems. Our expertise includes custom software development, machine learning solutions, and intelligent automation.',
              },
              {
                question: 'How long does a typical project take?',
                answer:
                  'Project timelines vary based on complexity and requirements. Simple websites may take 2-4 weeks, while complex AI applications can take 3-6 months. We provide detailed timelines during our initial consultation.',
              },
              {
                question: 'Do you provide ongoing support and maintenance?',
                answer:
                  'Yes, we offer comprehensive support and maintenance packages to ensure your applications continue to perform optimally. This includes updates, bug fixes, and feature enhancements.',
              },
              {
                question: 'What is your development process?',
                answer:
                  'We follow an agile development methodology with regular client communication, iterative development, and continuous testing to ensure high-quality deliverables that meet your expectations.',
              },
            ].map((faq, index) => (
              <motion.div
                key={index}
                ...
                className='bg-gradient-to-br from-gray-800/80 to-gray-900/80 rounded-2xl p-6 backdrop-blur-sm border border-gray-700/50'
              >
